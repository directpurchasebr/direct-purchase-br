...
export default function PessoaModal({ trigger, initialData }: Props) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="fixed z-50 top-1/2 left-1/2 w-[90vw] max-w-5xl -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl p-6 shadow-lg overflow-auto max-h-[90vh]">
                <VisuallyHidden>
